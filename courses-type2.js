...
try {
  ...
  document.write('<div class="row col-xs-12 courseSummaryRow2">');
  ...
  document.write('<div class="col-xs-12 col-sm-4 courseDetails instructors"><h5>Faculty: </h5><span class="faculty">' + faculty + '</span></div></div></div>');
